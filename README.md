...
It extends the original `Elevator` but performs request/rider insertions/deletions via HTTP calls instead of directly mutating arrays.
...
### Run the API + UI (Level 8 + Level 9)
